...
%       elf_main1_perScene          - Calibrates/unwarps images in an environment, then calculates HDR and intensity statistics for each scene
%       elf_main2_perEnvironment    - Calculates the mean image for an environment as the mean of all normalised HDR scenes
