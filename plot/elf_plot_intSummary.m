function h = elf_plot_intSummary(res, meanIm, infoSum, plotPara, name, nScenes)
% ELF_PLOT_SUMMARY creates the main ELF intensity summary graph
%
% elf_plot_intsummary(res, meanim, infosum, plotPara, name, name2)
% 
% Inputs: 
...
[h, plotPara] = elf_plot_createFigure(plotPara); % generate summary ELF plot
